...
part of 'rijksmuseum_api_client.dart';
...
class _Client implements Client {
  _Client(this._dio, {this.baseUrl, this.errorLogger}) {
  ...
  Future<GetCollectionResponse> getCollection() async {
    ...
    late GetCollectionResponse _value;
    try {
      _value = GetCollectionResponse.fromJson(_result.data!);
    } on Object catch (e, s) {
